...
Prerequisites for the codefresh tutorial:

1) A free GitHub account
2) A free Codefresh account
3) An account to a Docker registry service
4) The source code of the sample application
